...
const manifest: PaperclipPluginManifestV1 = {
  ...
  description:
    "Painel de agência criativa para visualizar, aprovar e reprovar conteúdo produzido por agentes. Preview visual de cards, comentários integrados com issues do Paperclip.",
